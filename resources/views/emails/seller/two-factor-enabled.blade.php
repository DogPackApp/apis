...
<tr>
    <td style="padding:0 40px 20px 40px;font-family:Helvetica, Avenir, sans-serif;font-size:16px;line-height:1.5;color:#333333;">
        ...
        @include('emails.seller.main-title', ['content' => 'Two-factor authentication enabled'])
        ...
        <p>
            Two-factor authentication has been turned on for your DogPack Marketplace seller account. You'll be asked for a one-time code every time you log in.
        </p>
